...
def main():
    ...
    while cap.isOpened():
        ...
        try:
            ...
            if fingers == 1:
                if areacnt < 2000:
                    cv2.putText(myFace, 'Avvicina la mano', (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA)
                else:
                    if arearatio < 12:
                ...
                cv2.putText(myFace, 'Scegli quali facce utilizzare inserendo valori da 1 a 4', (0, 50), font, 1,
        ...
        if flag == 1:
            ...
            if screen == 1:
                if flag1 == 1:
                    cv2.imwrite('image%2d.jpeg' % filenumber, myFace)
                    filenumber += 1
                    flag1 = 0
